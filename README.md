...
| Metric | Value |
|---|---|
| Rounds done | **5** (target: 100 rounds / 10,000 cases) |
| Cases collected | **500** |
| Last round | +100 cases · 700 raw issues scanned |
| Top symptom buckets | browser-quirk(164) · form-input(141) · media-cls(105) · focus-a11y(73) · race-state(67) · ssr-hydration(54) |
