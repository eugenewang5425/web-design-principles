...
| Metric | Value |
|---|---|
| Rounds done | **3** (target: 100 rounds / 10,000 cases) |
| Cases collected | **300** |
| Last round | +100 cases · 800 raw issues scanned |
| Top symptom buckets | browser-quirk(104) · form-input(79) · media-cls(63) · race-state(45) · focus-a11y(35) · ssr-hydration(25) |
