...
| Metric | Value |
|---|---|
| Rounds done | **4** (target: 100 rounds / 10,000 cases) |
| Cases collected | **400** |
| Last round | +100 cases · 800 raw issues scanned |
| Top symptom buckets | browser-quirk(136) · form-input(105) · media-cls(87) · race-state(58) · focus-a11y(53) · ssr-hydration(42) |
