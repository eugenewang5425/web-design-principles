...
| Metric | Value |
|---|---|
| Rounds done | **2** (target: 100 rounds / 10,000 cases) |
| Cases collected | **200** |
| Last round | +100 cases · 800 raw issues scanned |
| Top symptom buckets | browser-quirk(67) · form-input(53) · media-cls(43) · race-state(26) · focus-a11y(20) · ssr-hydration(17) |
