...
| Metric | Value |
|---|---|
| Rounds done | **6** (target: 100 rounds / 10,000 cases) |
| Cases collected | **600** |
| Last round | +100 cases · 900 raw issues scanned |
| Top symptom buckets | browser-quirk(194) · form-input(175) · media-cls(124) · focus-a11y(90) · race-state(81) · ssr-hydration(64) |
